...
namespace TransactionalOutbox.Banking.AccountService.Debezium;
...
public class ConnectorConfig
{
    ...
    [JsonPropertyName("topic.prefix")]
    public string TopicPrefix { get; set; } = default!;
    ...
    public string KafkaHistoryBootstrapServers { get; set; } = default!;
